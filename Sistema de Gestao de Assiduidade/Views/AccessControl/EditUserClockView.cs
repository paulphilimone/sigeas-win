...
namespace mz.betainteractive.sigeas.Views.AccessControl {
    public partial class EditUserClockView : Form {
        ...
        public EditUserClockView(SigeasDatabaseContext context) {
            InitializeComponent();            
        ...
        public void Edit(UserClock userclock) {
            ...
            CBoxClockState.Enabled = false;

            CBoxClockState.ResumeLayout();
        }
        ...
        bool validar() {
            ...
            if (CBoxClockState.SelectedIndex == -1) {
                MessageBox.Show(this, "Selecione o estado (Entrada/Saida)");
                CBoxClockState.Focus();
                return false;
            }
        ...
        private void GravarUserClock() {
            ...
            string state = CBoxClockState.SelectedItem as string;
